...
String _$searchHash() => r'cddfaff3c74e3fcbe870a00e536fc9b6a8440132';
...
/// See also [search].
class SearchFamily extends Family<AsyncValue<List<Article>>> {
  /// See also [search].
  const SearchFamily();
...
/// See also [search].
class SearchProvider extends AutoDisposeFutureProvider<List<Article>> {
  /// See also [search].
  ...
  Override overrideWith(
    FutureOr<List<Article>> Function(SearchRef provider) create,
  ) {
...
mixin SearchRef on AutoDisposeFutureProviderRef<List<Article>> {
